...
public class CrudAppTestSuite {
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("brychcy.krzysztof@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Marysia123");
    ...
    private void deleteTaskCrudApp(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).getText().equals(taskName))
                .forEach(theForm -> {
                    WebElement buttonDeletCard = theForm.findElement(By.xpath(".//button[4]"));
                    buttonDeletCard.click();
                });
    }
