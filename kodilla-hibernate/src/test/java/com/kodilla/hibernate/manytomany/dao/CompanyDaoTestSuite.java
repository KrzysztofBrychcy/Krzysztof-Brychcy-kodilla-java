...
public class CompanyDaoTestSuite {
    ...
    @Test
    public void testNewNamedQueries() {
        //Give
        Employee johnSmith = new Employee("John", "Smith");
        Employee stephanieClarckson = new Employee("Stephanie", "Clarckson");
        Employee lindaKovalsky = new Employee("Linda", "Kovalski");
        ...
        //When
        List<Employee> getEmploy = employeeDao.retrieveLastName("Kovalski");
        List<Company> getCompany = companyDao.retrieveFindCompany("Dat");
