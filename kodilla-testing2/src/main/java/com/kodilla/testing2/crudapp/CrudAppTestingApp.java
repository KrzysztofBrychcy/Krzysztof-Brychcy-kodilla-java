...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_TEXTARE = "//html/body/main/section/form/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        WebElement textareaField = driver.findElement(By.xpath(XPATH_TEXTARE));
